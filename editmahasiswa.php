...
$id = $_GET['nim'];
$sql = mysqli_query($conn, "SELECT * FROM ekobahran WHERE nim = '$id'");
...
if(isset($_POST['upload'])){
 ...
 $sql = "UPDATE ekobahran SET nama = '$nama', nim = '$nim', jeniskelamin = '$jk', programstudi = '$prodi', fakultas = '$fakultas', asal = '$asal', mottohidup = '$mottohidup' WHERE nim='$id'";
...
<body>
		...
		<form method="POST">
			...
			Nama : <input type="text" name="nama"  minlength="1" maxlength="35"  value="<?php echo $row["nama"];?>"><br><br>
